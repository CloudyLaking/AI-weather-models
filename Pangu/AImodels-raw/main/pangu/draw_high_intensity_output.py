...
def process_files(folder_path):
    ...
    for file in glob.glob(os.path.join(folder_path, "*.csv")):
        ...
        df = df[(df['PanguMinPressure'] < pressure_threshold) | (df['ECMWFMinPressure'] < pressure_threshold)]
...
# 主程序
folder_path = r"high_intensity_csv\new_"
...
plt.title('Typhoon Track Forecast Error under High Intensity(950hpa)', fontsize=14)
